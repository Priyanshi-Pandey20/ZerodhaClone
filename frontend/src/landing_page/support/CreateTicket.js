    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        <h1 className="fs-2  text-muted">
         To create a ticket, select a relevant option
        </h1>
        <div className="col-4 p-5 mt-2 mb-2">
         ...
         <i class="fa fa-plus-circle " aria-hidden="true"></i> Accounting Opening
          ...
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Company, Parternship and HUF Account</a><br/>
        ...
        <i class="fa fa-user-circle-o" aria-hidden="true"></i> Your Zerodha Account
         ...
         <i class="fa fa-bar-chart" aria-hidden="true"></i> Kite
          ...
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Senetial</a><br/>
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Kite API</a><br/>
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Pi and other plateforms</a><br/>
         ...
         <i class="fa fa-inr" aria-hidden="true"></i> Funds
          ...
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Funds Withdrawl</a><br/>
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>eMandates</a><br/>
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Adding Bank Acoounts</a><br/>
         
        </div>
         <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
         <i class="fa fa-ravelry" aria-hidden="true"></i> Console
          </h4>
         ...
         <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
       <i class="fa fa-handshake-o" aria-hidden="true"></i> Coin
          </h4>
          ...
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Manging your portfolio</a><br/>
